...
export class ActivityLogsAuthentification1769095096937 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "activity_logs" ADD CONSTRAINT "FK_c29be5a121446eff251fa05d0ec" FOREIGN KEY ("actor_user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
